...
lt.plugins.go.try_connect = (function try_connect(p__8381){var map__8383 = p__8381;var map__8383__$1 = ((cljs.core.seq_QMARK_.call(null,map__8383))?cljs.core.apply.call(null,cljs.core.hash_map,map__8383):map__8383);var info = cljs.core.get.call(null,map__8383__$1,new cljs.core.Keyword(null,"info","info",1017141280));var path = new cljs.core.Keyword(null,"path","path",1017337751).cljs$core$IFn$_invoke$arity$1(info);var client = lt.objs.clients.client_BANG_.call(null,new cljs.core.Keyword(null,"go.client","go.client",520858371));var obj = lt.object.create.call(null,new cljs.core.Keyword("lt.plugins.go","connecting-notifier","lt.plugins.go/connecting-notifier",2052045824),client);lt.object.add_tags.call(null,client,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tcp.client","tcp.client",3877789162)], null));
...
lt.plugins.go.__BEH__eval_BANG_ = (function __BEH__eval_BANG_(this$,event){var map__8385 = event;var map__8385__$1 = ((cljs.core.seq_QMARK_.call(null,map__8385))?cljs.core.apply.call(null,cljs.core.hash_map,map__8385):map__8385);var origin = cljs.core.get.call(null,map__8385__$1,new cljs.core.Keyword(null,"origin","origin",4300251800));var info = cljs.core.get.call(null,map__8385__$1,new cljs.core.Keyword(null,"info","info",1017141280));lt.objs.notifos.working.call(null,"");
...
var G__8387__delegate = function (cmd,succ_cb,fail_cb,args){var child = lt.plugins.go.exec.call(null,[cljs.core.str(cmd),cljs.core.str(args)].join(''),null,(function (err,stdout,stderr){if(cljs.core.truth_(err))
...
var G__8387 = function (cmd,succ_cb,fail_cb,var_args){
var args = null;if (arguments.length > 3) {
  args = cljs.core.array_seq(Array.prototype.slice.call(arguments, 3),0);} 
return G__8387__delegate.call(this,cmd,succ_cb,fail_cb,args);};
G__8387.cljs$lang$maxFixedArity = 3;
G__8387.cljs$lang$applyTo = (function (arglist__8388){
var cmd = cljs.core.first(arglist__8388);
arglist__8388 = cljs.core.next(arglist__8388);
var succ_cb = cljs.core.first(arglist__8388);
arglist__8388 = cljs.core.next(arglist__8388);
var fail_cb = cljs.core.first(arglist__8388);
var args = cljs.core.rest(arglist__8388);
return G__8387__delegate(cmd,succ_cb,fail_cb,args);
});
...
lt.plugins.go.__BEH__finish_update_hints = (function __BEH__finish_update_hints(editor,res){var hints = cljs.core.map.call(null,(function (p1__8386_SHARP_){return {"completion": p1__8386_SHARP_};
