...
goog.require('lt.objs.command');
goog.require('lt.objs.editor');
lt.object.object_STAR_.call(null,new cljs.core.Keyword("lt.plugins.go","go-lang","lt.plugins.go/go-lang",1766929064),new cljs.core.Keyword(null,"tags","tags",1017456523),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"go.lang","go.lang",1161134758),null], null), null),new cljs.core.Keyword(null,"behaviors","behaviors",607554515),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("lt.plugins.go","fmt","lt.plugins.go/fmt",1644693386)], null));
...
lt.plugins.go.try_connect = (function try_connect(p__8638){var map__8640 = p__8638;var map__8640__$1 = ((cljs.core.seq_QMARK_.call(null,map__8640))?cljs.core.apply.call(null,cljs.core.hash_map,map__8640):map__8640);var info = cljs.core.get.call(null,map__8640__$1,new cljs.core.Keyword(null,"info","info",1017141280));var path = new cljs.core.Keyword(null,"path","path",1017337751).cljs$core$IFn$_invoke$arity$1(info);var client = lt.objs.clients.client_BANG_.call(null,new cljs.core.Keyword(null,"go.client","go.client",520858371));var obj = lt.object.create.call(null,new cljs.core.Keyword("lt.plugins.go","connecting-notifier","lt.plugins.go/connecting-notifier",2052045824),client);lt.object.add_tags.call(null,client,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tcp.client","tcp.client",3877789162)], null));
...
lt.plugins.go.__BEH__eval_BANG_ = (function __BEH__eval_BANG_(this$,event){var map__8642 = event;var map__8642__$1 = ((cljs.core.seq_QMARK_.call(null,map__8642))?cljs.core.apply.call(null,cljs.core.hash_map,map__8642):map__8642);var origin = cljs.core.get.call(null,map__8642__$1,new cljs.core.Keyword(null,"origin","origin",4300251800));var info = cljs.core.get.call(null,map__8642__$1,new cljs.core.Keyword(null,"info","info",1017141280));lt.objs.notifos.working.call(null,"");
...
{return cljs.core.println.call(null,[cljs.core.str("err: "),cljs.core.str(err)].join(''));
} else
{return null;
}
}));return null;
...
run_cmd.cljs$lang$applyTo = (function (arglist__8643){
var cmd = cljs.core.first(arglist__8643);
...
;
lt.plugins.go.gofmt = (function gofmt(){var current_file = lt.plugins.go.cwf__GT_path.call(null);var cmd = [cljs.core.str("gofmt -w "),cljs.core.str(current_file)].join('');lt.objs.notifos.working.call(null,"gofmting...");
lt.plugins.go.run_cmd.call(null,cmd);
return lt.objs.notifos.done_working.call(null,"");
});
lt.plugins.go.__BEH__fmt = (function __BEH__fmt(){return cljs.core.println.call(null,"Saved!");
});
lt.object.behavior_STAR_.call(null,new cljs.core.Keyword("lt.plugins.go","fmt","lt.plugins.go/fmt",1644693386),new cljs.core.Keyword(null,"reaction","reaction",4441361819),lt.plugins.go.__BEH__fmt,new cljs.core.Keyword(null,"triggers","triggers",2516997421),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"save","save",1017427183),null], null), null));
lt.objs.command.command.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"command","command",1964298941),new cljs.core.Keyword("lt.plugins.go","go.fmt","lt.plugins.go/go.fmt",4770938260),new cljs.core.Keyword(null,"desc","desc",1016984067),"Go: fmt current file",new cljs.core.Keyword(null,"exec","exec",1017031683),lt.plugins.go.gofmt], null));
}
