...
lt.plugins.go.try_connect = (function try_connect(p__8325){var map__8327 = p__8325;var map__8327__$1 = ((cljs.core.seq_QMARK_.call(null,map__8327))?cljs.core.apply.call(null,cljs.core.hash_map,map__8327):map__8327);var info = cljs.core.get.call(null,map__8327__$1,new cljs.core.Keyword(null,"info","info",1017141280));var path = new cljs.core.Keyword(null,"path","path",1017337751).cljs$core$IFn$_invoke$arity$1(info);var client = lt.objs.clients.client_BANG_.call(null,new cljs.core.Keyword(null,"go.client","go.client",520858371));var obj = lt.object.create.call(null,new cljs.core.Keyword("lt.plugins.go","connecting-notifier","lt.plugins.go/connecting-notifier",2052045824),client);lt.object.add_tags.call(null,client,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tcp.client","tcp.client",3877789162)], null));
...
lt.plugins.go.__BEH__eval_BANG_ = (function __BEH__eval_BANG_(this$,event){var map__8329 = event;var map__8329__$1 = ((cljs.core.seq_QMARK_.call(null,map__8329))?cljs.core.apply.call(null,cljs.core.hash_map,map__8329):map__8329);var origin = cljs.core.get.call(null,map__8329__$1,new cljs.core.Keyword(null,"origin","origin",4300251800));var info = cljs.core.get.call(null,map__8329__$1,new cljs.core.Keyword(null,"info","info",1017141280));lt.objs.notifos.working.call(null,"");
...
var G__8331__delegate = function (cmd,succ_cb,fail_cb,args){var child = lt.plugins.go.exec.call(null,[cljs.core.str(cmd),cljs.core.str(args)].join(''),null,(function (err,stdout,stderr){if(cljs.core.truth_(err))
...
var G__8331 = function (cmd,succ_cb,fail_cb,var_args){
var args = null;if (arguments.length > 3) {
  args = cljs.core.array_seq(Array.prototype.slice.call(arguments, 3),0);} 
return G__8331__delegate.call(this,cmd,succ_cb,fail_cb,args);};
G__8331.cljs$lang$maxFixedArity = 3;
G__8331.cljs$lang$applyTo = (function (arglist__8332){
var cmd = cljs.core.first(arglist__8332);
arglist__8332 = cljs.core.next(arglist__8332);
var succ_cb = cljs.core.first(arglist__8332);
arglist__8332 = cljs.core.next(arglist__8332);
var fail_cb = cljs.core.first(arglist__8332);
var args = cljs.core.rest(arglist__8332);
return G__8331__delegate(cmd,succ_cb,fail_cb,args);
});
...
lt.plugins.go.__BEH__finish_update_hints = (function __BEH__finish_update_hints(editor,res){var hints = cljs.core.map.call(null,(function (p1__8330_SHARP_){return {"completion": p1__8330_SHARP_};
