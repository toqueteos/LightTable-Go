...
goog.require('lt.objs.command');
goog.require('lt.objs.editor');
lt.object.object_STAR_.call(null,new cljs.core.Keyword("lt.plugins.go","go-lang","lt.plugins.go/go-lang",1766929064),new cljs.core.Keyword(null,"tags","tags",1017456523),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"go.lang","go.lang",1161134758),null], null), null),new cljs.core.Keyword(null,"behaviors","behaviors",607554515),cljs.core.PersistentVector.EMPTY);
lt.plugins.go.go = lt.object.create.call(null,new cljs.core.Keyword("lt.plugins.go","go-lang","lt.plugins.go/go-lang",1766929064));
lt.plugins.go.try_connect = (function try_connect(p__8437){var map__8439 = p__8437;var map__8439__$1 = ((cljs.core.seq_QMARK_.call(null,map__8439))?cljs.core.apply.call(null,cljs.core.hash_map,map__8439):map__8439);var info = cljs.core.get.call(null,map__8439__$1,new cljs.core.Keyword(null,"info","info",1017141280));var path = new cljs.core.Keyword(null,"path","path",1017337751).cljs$core$IFn$_invoke$arity$1(info);var client = lt.objs.clients.client_BANG_.call(null,new cljs.core.Keyword(null,"go.client","go.client",520858371));var obj = lt.object.create.call(null,new cljs.core.Keyword("lt.plugins.go","connecting-notifier","lt.plugins.go/connecting-notifier",2052045824),client);lt.object.add_tags.call(null,client,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tcp.client","tcp.client",3877789162)], null));
...
lt.plugins.go.__BEH__eval_BANG_ = (function __BEH__eval_BANG_(this$,event){var map__8441 = event;var map__8441__$1 = ((cljs.core.seq_QMARK_.call(null,map__8441))?cljs.core.apply.call(null,cljs.core.hash_map,map__8441):map__8441);var origin = cljs.core.get.call(null,map__8441__$1,new cljs.core.Keyword(null,"origin","origin",4300251800));var info = cljs.core.get.call(null,map__8441__$1,new cljs.core.Keyword(null,"info","info",1017141280));lt.objs.notifos.working.call(null,"");
...
var G__8443__delegate = function (cmd,succ_cb,fail_cb,args){var child = lt.plugins.go.exec.call(null,[cljs.core.str(cmd),cljs.core.str(args)].join(''),null,(function (err,stdout,stderr){if(cljs.core.truth_(err))
...
var G__8443 = function (cmd,succ_cb,fail_cb,var_args){
var args = null;if (arguments.length > 3) {
  args = cljs.core.array_seq(Array.prototype.slice.call(arguments, 3),0);} 
return G__8443__delegate.call(this,cmd,succ_cb,fail_cb,args);};
G__8443.cljs$lang$maxFixedArity = 3;
G__8443.cljs$lang$applyTo = (function (arglist__8444){
var cmd = cljs.core.first(arglist__8444);
arglist__8444 = cljs.core.next(arglist__8444);
var succ_cb = cljs.core.first(arglist__8444);
arglist__8444 = cljs.core.next(arglist__8444);
var fail_cb = cljs.core.first(arglist__8444);
var args = cljs.core.rest(arglist__8444);
return G__8443__delegate(cmd,succ_cb,fail_cb,args);
});
...
lt.plugins.go.gofmt = (function gofmt(file){var cmd = [cljs.core.str("gofmt -w "),cljs.core.str(file)].join('');var editor = lt.plugins.go.get_last_active_editor.call(null);var pos = lt.objs.editor.__GT_cursor.call(null,editor);var success_callback = ((function (cmd,editor,pos){
...
;var failure_callback = ((function (cmd,editor,pos,success_callback){
return (function (){return lt.objs.notifos.done_working.call(null,"Unable to format");
});})(cmd,editor,pos,success_callback))
...
lt.objs.editor.dirty_QMARK_.call(null,lt.plugins.go.get_last_active_editor.call(null));
...
lt.plugins.go.__BEH__finish_update_hints = (function __BEH__finish_update_hints(editor,res){var hints = cljs.core.map.call(null,(function (p1__8442_SHARP_){return {"completion": p1__8442_SHARP_};
